...
class DataSummaryTest(TestCase):
    ...
    def test_get(self):
        ...
        response = ds.get(request)
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, 'Mus musculus</a>: 2 <br />')
        self.assertContains(response, 'Homo sapiens</a>: 1 <br />')
        self.assertNotContains(response, 'Mus musculus</a>: 1 <br />')
        self.assertNotContains(response, 'Homo sapiens</a>: 2 <br />')
