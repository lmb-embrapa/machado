...
from chado.models import Organism, Phylonode
...
class PhylotreeTest(TestCase):
    ...
    def test_store_type_def(self):
        ...
        organism_db.store_organism_record(taxid=1,
                                          scname='root',
                                          synonyms=[],
                                          common_names=[])
        organism_db.store_organism_record(taxid=2,
                                          scname='Ilex',
                                          synonyms=[],
                                          common_names=[])
        organism_db.store_organism_record(taxid=3,
                                          scname='Ilex paraguariensis',
                                          synonyms=[],
                                          common_names=[])
        organism_db.store_organism_record(taxid=4,
                                          scname='Ilex montana',
                                          synonyms=[],
                                          common_names=[])

        tree = {1: {'parent_id': None,
                    'level': 'no rank',
                    'children': [1, 2],
                    'left_idx': 1,
                    'right_idx': 8},
        ...
        phylotree = PhylotreeLoader(phylotree_name='testTaxonomy',
                                    organism_db='testOrganism')
